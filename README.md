...
- Pure Python 3.10+ standard library — zero pip dependencies; Docker support included; 81 passing tests including a release-blocking privacy regression test — the real-LLM path is verified end-to-end against a live model
