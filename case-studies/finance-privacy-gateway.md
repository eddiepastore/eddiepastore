...
**81 passing tests** — Including a release-blocking privacy regression test that proves the leak scanner and runtime gate cannot drift apart.
...
- 81 tests including `test_privacy_regression.py` (release-blocking)
